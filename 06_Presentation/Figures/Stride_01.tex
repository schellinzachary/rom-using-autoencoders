\begin{tikzpicture}
	...
	%kernel label
	\draw [scale=.45,below] node at (1,6)  {\LARGE Kernel};
	%kernel components
	...
	%step 1 equation
	\draw [scale=.45] node [text width=2cm,align=center] at (5.5,6.5) {\LARGE \(o=\mathbf{a}*v+\mathbf{b}*w+\mathbf{c}*x+\mathbf{d}*y\)};
	%step 2 equation
	\draw [scale=.45] node [text width=2cm,align=center] at (14.5,6.5) {\LARGE \(p=\mathbf{c}*v+\mathbf{d}*w+\mathbf{e}*x+\mathbf{f}*y\)};
	\draw [thick, draw=black, fill=black!40!white,scale = .45] (0,2) rectangle (2,4);
	\draw [thick, draw=black,scale=.45] (0,0) grid  (4,4) node at (2,0)[below] {\LARGE Input};
	\draw [thick, draw=black, fill=black!40!white,scale = .45] (5,2) rectangle  (6,3);
	\draw [thick, draw=black,scale = .45] (5,0) grid  (8,3) node at (6.5,0) [below,text width=1.5cm,align= center] {\LARGE Feature map};
	%
	\draw [thick, draw=black, fill=black!40!white,scale = .45] (10,2) rectangle  (12,4);
	\draw [thick, draw=black,scale = .45] (9,0) grid  (13,4) node at (11,0) [below] {\LARGE Input};
	\draw [thick, draw=black, fill=black!40!white,scale = .45] (15,2) rectangle  (16,3);
	\draw [thick, draw=black,scale = .45] (14,0) grid  (17,3) node at (15.5,0) [below, text width=1.5cm,align=center] {\LARGE Feature map};
	%draw arrows
	...
	%draw step
	\draw [scale=.45] node[rotate=-30]   at (5,4.7) {\LARGE Step 1};
	\draw [scale=.45] node[rotate=-30]   at (15,4.7) {\LARGE Step 2};
	%draw abc step 1
	...
	\draw [scale=.45] node at (5.5,2.5) {o};
	\draw [scale=.45] node at (6.5,2.5) {p};
%	%draw abc step 2
	...
	\draw [scale=.45] node at (14.5,2.5) {o};
	\draw [scale=.45] node at (15.5,2.5) {p};
\end{tikzpicture}
