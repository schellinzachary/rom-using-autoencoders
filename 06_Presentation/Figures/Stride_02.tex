\begin{tikzpicture}
	...
	%step 2 equation
	\draw [scale=.45] node [text width=2cm,align=center] at (13.5,6.5) {\LARGE \(p=\mathbf{e}*v+\mathbf{f}*w+\mathbf{g}*x+\mathbf{h}*y\)};
	...
	\draw [thick, draw=black,scale = .45] (5,0) grid  (7,2) node at (6.1,0) [below,text width=1.5cm,align= center] {\LARGE Feature map};;
	%
	...
	\draw [thick, draw=black,scale = .45] (14,0) grid  (16,2) node at (15.1,0) [below, text width=1.5cm,align=center] {\LARGE Feature map};;
	%draw arrows
	...
	%draw step
	\draw [scale=.45] node[rotate=-30]   at (5,4.1) {\LARGE Step 1};
 	\draw [scale=.45] node[rotate=-30]   at (15,4.1) {\LARGE Step 2};
	%draw abc step 1
