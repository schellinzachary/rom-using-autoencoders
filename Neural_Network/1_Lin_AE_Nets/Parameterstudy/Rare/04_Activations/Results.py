...
checkpoint = torch.load('Results/ELU_Tanh_test-4000.pt')
...
plt.title('ELU')
plt.legend()
#tikzplotlib.save('/home/zachi/ROM_using_Autoencoders/Bachelorarbeit/Figures/Parameterstudy/Activations/Rare/ELU.tex')
plt.show()