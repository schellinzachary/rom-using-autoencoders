...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.convE1 = nn.Conv2d(1,2,(5,10),stride=(2,5))
        self.convE2 = nn.Conv2d(2,4,(4,6),stride=(2,3))
        self.convE3 = nn.Conv2d(4,8,(3,8),stride=(2,4))
        self.linearE1 = nn.Linear(in_features=32,out_features=3)
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.linearD1 = nn.Linear(in_features=3, out_features=32)
        self.convD1 = nn.ConvTranspose2d(8,4,(3,8),stride=(2,4))
        self.convD2 = nn.ConvTranspose2d(4,2,(4,6),stride=(2,3))
        self.convD3 = nn.ConvTranspose2d(2,1,(3,10),stride=(2,5))
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
