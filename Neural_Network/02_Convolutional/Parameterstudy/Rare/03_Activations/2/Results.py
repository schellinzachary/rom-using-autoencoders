...
for i in act_list:
    ...
    class Encoder(nn.Module):
        def __init__(self):
            ...
            self.convE1 = nn.Conv2d(1,12,(6,10),stride=(3,10))
            self.convE2 = nn.Conv2d(12,24,(4,10),stride=(4,10))
            self.linearE1 = nn.Linear(in_features=96,out_features=5)
    ...
    class Decoder(nn.Module):
        def __init__(self):
            ...
            self.linearD1 = nn.Linear(in_features=5, out_features=96)
            self.convD1 = nn.ConvTranspose2d(24,12,(4,10),stride=(4,10))
            self.convD2 = nn.ConvTranspose2d(12,1,(4,10),stride=(3,10))
            self.add_module('act',i)
            # self.add_module('act_c',act_c_list[i])
