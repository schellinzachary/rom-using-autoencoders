...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.convE1 = nn.Conv2d(1,6,(5,10),stride=(2,5))
        self.convE2 = nn.Conv2d(6,12,(2,5),stride=(1,3))
        self.convE3 = nn.Conv2d(12,24,(3,4),stride=(2,2))
        self.convE4 = nn.Conv2d(24,48,(3,3),stride=(2,2))
        self.linearE1 = nn.Linear(in_features=192,out_features=3)
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.linearD1 = nn.Linear(in_features=3, out_features=192)
        self.convD1 = nn.ConvTranspose2d(48,24,(3,3),stride=(2,2)) 
        self.convD2 = nn.ConvTranspose2d(24,12,(3,10),stride=(2,10))
        self.convD3 = nn.ConvTranspose2d(12,6,(6,2),stride=(1,2)) 
        self.convD4 = nn.ConvTranspose2d(6,1,(10,2),stride=(1,2))
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
...
checkpoint = torch.load('Results/3.pt')
