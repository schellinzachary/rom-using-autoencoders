...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.convE2 = nn.Conv2d(8,36,(4,6),stride=(2,3))
        self.convE3 = nn.Conv2d(36,64,(3,8),stride=(2,4))
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.convD1 = nn.ConvTranspose2d(64,36,(3,8),stride=(2,4))
        self.convD2 = nn.ConvTranspose2d(36,8,(4,6),stride=(2,3))
...
checkpoint = torch.load('Results/5.pt')
