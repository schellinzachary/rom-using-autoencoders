...
rho_predict = np.load('/home/zachary/tubCloud/BA/BA_Win/Neural_Network/Results/rho_predict1.npy')
rho_samples = np.load('/home/zachary/tubCloud/BA/BA_Win/Neural_Network/Results/rho_samples1.npy')
plt.ion()
plt.figure(1)
for i in range(25):   
