...
#load data
f = np.load('/home/zachi/ROM_using_Autoencoders/05_Misc/Neural_Network/Preprocessing/Data/sod25Kn0p01_4D.npy')
...
act_list = [nn.LeakyReLU(),nn.SiLU(),nn.ELU(),nn.Tanh()]
...
for i in range(5):
    ...
    torch.save({
        ...
        'model': model
        # },'Results/Results/{}.pt'.format((act_list[i],act_c_list[i])))
        },'Results/sh4{}.pt'.format(act_list[i]))
