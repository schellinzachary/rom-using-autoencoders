...
class Encoder_3(nn.Module):
    def __init__(self):
        ...
        self.convE1 = nn.Conv2d(1,4,(3,3),
            stride=(3,3),
            padding=(1,1)
            )
        self.convE2 = nn.Conv2d(4,8,(3,3),
            stride=(3,3),
            padding=(0,1)
            )
        self.convE3 = nn.Conv2d(8,16,(3,3),
            stride=(3,3),
            padding=(0,1)
            )
...
},'Results_layer/model{}-epoch{}-val_loss{:.3E}s.pt'.format(7,
    k_models[i,1],
    k_models[i,0]))
#save last model
torch.save({
    ...
    },'Results_layer/last-model-{}.pt'.format(7))
