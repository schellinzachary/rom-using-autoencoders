...
for idx_m in range(2):
    ...
    for idx_a, ac_combo in enumerate(experiments):
        ...
        },'Results_act/btch/model{}-act-{}-epoch{}-val_loss{:.3E}.pt'.format(idx_m,
            ac_combo,
            k_models[i,1],
            k_models[i,0]))
        #save last model
        torch.save({
            ...
            },'Results_act/btch/last-model-{}-act-{}.pt'.format(idx_m,
                ac_combo))
