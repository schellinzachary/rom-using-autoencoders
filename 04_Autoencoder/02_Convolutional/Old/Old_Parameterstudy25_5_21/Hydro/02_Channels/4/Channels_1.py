...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.convE2 = nn.Conv2d(2,4,(2,5),stride=(1,3))
        self.convE3 = nn.Conv2d(4,8,(3,4),stride=(2,2))
        self.convE4 = nn.Conv2d(8,16,(3,3),stride=(2,2))
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.convD1 = nn.ConvTranspose2d(16,8,(3,3),stride=(2,2)) 
        self.convD2 = nn.ConvTranspose2d(8,4,(3,10),stride=(2,10))
        self.convD3 = nn.ConvTranspose2d(4,2,(6,2),stride=(1,2)) 
        self.convD4 = nn.ConvTranspose2d(2,1,(10,2),stride=(1,2))
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
