...
for i in act_list:
    ...
    class Encoder(nn.Module):
        def __init__(self):
            ...
            self.convE2 = nn.Conv2d(4,8,(4,6),stride=(2,3))
            self.convE3 = nn.Conv2d(8,16,(3,8),stride=(2,4))
    ...
    class Decoder(nn.Module):
        def __init__(self):
            ...
            self.convD1 = nn.ConvTranspose2d(16,8,(3,8),stride=(2,4))
            self.convD2 = nn.ConvTranspose2d(8,4,(4,6),stride=(2,3))
            self.convD3 = nn.ConvTranspose2d(4,1,(3,10),stride=(2,5))
            self.add_module('act',i)
            # self.add_module('act_c',act_c_list[i])
    ...
    checkpoint = torch.load('Results/Results/{}.pt'.format(i),map_location='cpu')
    ...
    plt.legend()
    #tikzplotlib.save('/home/zachi/ROM_using_Autoencoders/Bachelorarbeit/Figures/Parameterstudy/Convolutional/Activations/L3R.tex')
plt.show()
