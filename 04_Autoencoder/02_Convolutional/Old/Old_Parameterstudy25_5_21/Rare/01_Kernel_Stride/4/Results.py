...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.convD1 = nn.ConvTranspose2d(64,32,(3,3),stride=(2,2)) 
        self.convD2 = nn.ConvTranspose2d(32,16,(3,10),stride=(2,10)) 
        self.convD3 = nn.ConvTranspose2d(16,8,(6,2),stride=(1,2)) 
...
plt.title('4 Layer')
plt.legend()
tikzplotlib.save('/home/zachi/ROM_using_Autoencoders/Bachelorarbeit/Figures/Parameterstudy/Convolutional/Layers/4Layer.tex')
plt.show()
