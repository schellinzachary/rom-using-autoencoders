...
%\newcommand{\ae1}{\(\alpha_1\)}
%\newcommand{\ae2}{\(\alpha_2\)}
%\newcommand{\ae2}{\(\alpha_3\)}
%Tikz Styles
...
rarefaction KN
SOD
\subsection{Sod's schock tube as a test case for the BGK model} \label{FeaturesSOD}
\begin{figure}[!htbp]
