...
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Hydro/0.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Hydro/1.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Hydro/2.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Hydro/3.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Hydro/4.tex}}
...
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Rare/0.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Rare/1.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Rare/2.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Rare/3.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Depth/Rare/4.tex}}
...
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/2.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/4.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/8.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/10.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/12.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/14.tex}}
...
\begin{center}
	\begin{figure}[htbp!]\ContinuedFloat
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/16.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Hydro/32.tex}}
		\caption{Training with different mini-batch sizes for \hy. Train -and test loss is shown over 5000 epochs.}
		\label{}
	\end{figure}
\end{center}
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/2.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/4.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/6.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/8.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/10.tex}}
...
\begin{center}
	\begin{figure}[htbp!]\ContinuedFloat
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/16.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Batch_Size/Rare/32.tex}}
		\caption{Training with different mini-batch sizes for \rare. Train -and test loss is shown over 5000 epochs.}
		\label{}
	\end{figure}
\end{center}
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/ReLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/ELU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/Tanh.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/SiLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/LeakyReLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/ELU_Tanh.tex}}
		\caption{balblabla}
...
\begin{center}
	\begin{figure}[htbp!]\ContinuedFloat
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/LeakyReLU_Tanh.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Hydro/ELU_SiLU.tex}}
		\caption{}
	\end{figure}
\end{center}
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ReLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ELU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/Tanh.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/SiLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/LeakyReLU.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ELU_Tanh.tex}}
		\caption{blablabla}
...
\begin{center}
	\begin{figure}[htbp!]\ContinuedFloat
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/LeakyReLU_Tanh.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ELU_SiLU.tex}}
		\caption{blablabla}
		\label{}
	\end{figure}
\end{center}
\begin{center}
	\begin{figure}[htbp!]
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ELU_test.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/LeakyReLU_Tanh_test.tex}}
		\scalebox{.9}{\input{Figures/Parameterstudy/Activations/Rare/ELU_Tanh_test.tex}}
		\caption{blablabla}
