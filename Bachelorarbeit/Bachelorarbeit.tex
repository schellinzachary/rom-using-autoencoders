...
State of the art model reduction of dynamical systems is done via proper orthogonal decmposition (POD) which is an algorithm incorporating singular value decomposition (SVD)\cite{Franz}\cite{Kutz}.   
