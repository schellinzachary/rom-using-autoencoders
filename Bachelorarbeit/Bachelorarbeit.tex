...
Subsequently the activations in the layers will be studied. First, five activations which will be applied to all the four layers. After training the L2-Error\cref{labellist} will be evaluated on the unshuffled, complete dataset as described in \cref{Sec: Data Sampling}. results can be onserved in \cref{Tab:Activations}.
\begin{table}[!htbp]\centering
