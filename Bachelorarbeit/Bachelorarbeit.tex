...
\end{table}
Originally the number of layers is determined, as they set a big part of the representational capacity of the model hence can initiate over- and underfitting at an early stage. \Cref{Fig:layer_size} in \cref{AppendixA} shows the training and validation error for five designs shown in \cref{labellist}.
\begin{table}[!htbp]\centering
	\begin{tabular}{ |c|c| }
		\hline
