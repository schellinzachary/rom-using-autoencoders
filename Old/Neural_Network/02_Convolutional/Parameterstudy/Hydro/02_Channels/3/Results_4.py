...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.convE1 = nn.Conv2d(1,9,(5,10),stride=(2,5))
        self.convE2 = nn.Conv2d(9,18,(4,6),stride=(2,3))
        self.convE3 = nn.Conv2d(18,36,(3,8),stride=(2,4))
        self.linearE1 = nn.Linear(in_features=144,out_features=3)
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.linearD1 = nn.Linear(in_features=3, out_features=144)
        self.convD1 = nn.ConvTranspose2d(36,18,(3,8),stride=(2,4))
        self.convD2 = nn.ConvTranspose2d(18,9,(4,6),stride=(2,3))
        self.convD3 = nn.ConvTranspose2d(9,1,(3,10),stride=(2,5))
        self.act = nn.Tanh()
        #self.act_c = nn.Tanh()
...
checkpoint = torch.load('Results/4.pt')
