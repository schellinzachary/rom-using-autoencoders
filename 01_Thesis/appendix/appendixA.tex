...
\begin{center}
	...
	\end{figure}
\end{center}
Next the mini-batch size is analysed. Epochs are increased by 1000 epochs, as training- nd validation error did not fully converge for \(\rare\) as seen in \cref{Fig:Width}. Results are displayed in \cref{Tab:Batch} for $\hy$  and  $\rare$. For both input data experiments are conducted with mini-batch sizes of 2,4,8,16,32.
\begin{table}[htp]
	\centering
