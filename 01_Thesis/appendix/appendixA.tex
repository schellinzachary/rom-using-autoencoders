...
\begin{center}
	\begin{figure}[H]
		...
		\label{Fig:kFold}
		\caption{Training- and validation error over epochs for the five folds.}
	\end{figure}
\end{center}
