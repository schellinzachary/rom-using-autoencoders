...
The difference in number of paramters the slip- and the continuum flow require for the FCNN to achieve quite similar results aligns with the assumption, that   