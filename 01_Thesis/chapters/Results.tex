...
Both neural networks are tested against POD. By fixing \(p\) the algorithm is artificially limited and performs under it's abilities. Though, POD uses with this adjustement 5 to six times more parameters than the FCNN. It's determinstic character enables POD to achieve any possible accuracy, which was not observed with the neural networks.    
