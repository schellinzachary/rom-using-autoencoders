...
Further Considerations, proposed for future works, is to test LSTM (long short term memory) cells or similarily GRUs (gated recurrent units) in a encoder-decoder configuration to evolve the intrinsic variables in time, against projection methods like the Galerkin projection.   