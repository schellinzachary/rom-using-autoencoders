...
\begin{enumerate}
	\item What is the BGK Model
	\item What is the SOD and BGK in SOD
	\item What is deep learning what are autoencoders
	\item hyperparameters for autoencoders
	\item What is a reduced order model 
	\item offline phase 
	\item my data in 1d bgk in sod shock tube FOM Data
	\item what is pod and Rb by POD 
	\item RB by autoencoder -online phase
	\item what is my ROM 
	\item results - results by ROM for FC and for CONV 
	\item variation of intrinsic variables 
	\item Comparion to POD intrinsic variables number and quality
\end{enumerate}
