...
\begin{figure}[H]
	...
	\begin{subfigure}{\textwidth}
		...
		\caption{Macroscopic quantities \(rho\), \(\rho u\) and \(E\) in the SOD schock tube at \(t=0.12s\). The quantites are displayed for \(\Kn=0.00001\)  in - - lines and for \(\Kn=0.01\) in - lines.}
	\end{subfigure}
\end{figure}
