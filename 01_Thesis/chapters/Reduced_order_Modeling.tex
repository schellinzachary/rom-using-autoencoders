...
\begin{table}[htp]
	...
	\begin{tabular*}{15cm}{ @{\extracolsep{\fill}} c c c c @{} }
		\toprule
		Variable   & Number of nodes&   Domain extension& Step size (uniform)\\   
		\hline
...
\end{table}
One is a slip flow with \(Kn=0.01\). For this kind of rarefaction the 
\begin{multicols}{2}
	\begin{equation}
	\Pi_{AE} = \begin{bmatrix}
