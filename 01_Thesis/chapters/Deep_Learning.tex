...
Dimensionality reduction algorithms lie at the heart of any reduced order model (ROM). As input serve datasets such as solutions of a full order model (FOM) or experimental data. The output is an approximation to the input.\\
-dynamical systems\\
-capture dynamics of the system\\      
