...
loc_plot = "rom-using-autoencoders/01_Thesis/Figures/Parameterstudy/Fully_Connected/Depth/hydro_depthtttt.tex"
...
from pathlib import Path
home = Path.home()
loc_chpt = "rom-using-autoencoders/01_Thesis/python/Appendix_A/Parameterstudy/Hydro/01_Depth"
...
print("Experiment FCNN Depth Hydro")
print(loss_dict)