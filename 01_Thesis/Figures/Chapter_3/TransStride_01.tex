...
\draw [thick, draw=black,scale=.45] (-1,-1) grid  (4,4) node at (1.5,-1)[below] {\footnotesize Input};
% step 1 featuremap
...
%draw abc step 1
\draw [scale=.45] node at (-.5,3.5) {a};
\draw [scale=.45] node at (-.5,1.5) {b};
\draw [scale=.45] node at (-.5,-.5) {c};
\draw [scale=.45] node at (1.5,3.5) {d};
\draw [scale=.45] node at (1.5,1.5) {e};
\draw [scale=.45] node at (1.5,-.5) {f};
\draw [scale=.45] node at (3.5,3.5) {g};
\draw [scale=.45] node at (3.5,1.5) {h};
\draw [scale=.45] node at (3.5,-.5) {i};
