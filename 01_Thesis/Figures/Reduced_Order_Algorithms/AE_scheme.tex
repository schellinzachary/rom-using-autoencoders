...
\draw [arrow,thin](times) -- (plus) node[midway,xshift=1ex] {\footnotesize $I^*$};
...
%%forpass
%\draw[arrow,thin] (0,3.6)--(12,3.6)node [midway,above]{\footnotesize Forward Pass};
%%bckpass
%\draw[arrow,thin] (12,4.1)--(0,4.1)node [midway,above]{\footnotesize Backward Pass};
