...
%stride 1
%kernel
\draw [thin, draw=blue, fill=black!30!white,scale = .45] (-1,5) rectangle (2,8) grid (-1,5);
%kernel label
...
\draw [thick, draw=black,scale=.45] (-1,-1) grid  (2,2) node at (1.5,-1)[below] {\footnotesize Input};
% step 1 featuremap
%\draw [thick, draw=black, fill=black!40!white,scale = .45] (5,2) rectangle  (6,3);
\draw [thin, draw=blue,scale = .45] (5,1) grid  (12,8) node at (7,-1) [below,text width=2cm,align= center] {\footnotesize Feature map at step 1};
%%step 2 featuremap
